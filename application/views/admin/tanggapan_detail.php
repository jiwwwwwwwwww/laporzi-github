    ...
    <div class="card no-border mb-3 col-lg-8">
        ...
        <div class="row no-gutters">
            <div class="col-md-6 text-center">
                <img src="<?= base_url() ?>assets/uploads/<?= $data_pengaduan['foto'] ?>" alt="" class="mt-2 mb-2"
                    width="250">
            </div>
            ...
            <div class="col-md-6">
                <div class="card-body">
                    ...
                    <p class="card-text">Status : <?= $data_pengaduan['status'] == 0 ? 'Belum di verifikasi' : ''; ?>
                    </p>
                    <p class="card-text"><small class="text-muted">Laporan :
                            <?= $data_pengaduan['isi_laporan'] ?></small></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="status" id="status-setuju" value="proses"
                        checked="">
